...
npx esbuild ./src/lambdas/checkScheduledSecretsForDeletion/index.ts --bundle --platform=node --outfile=./dist/lambdas/checkScheduledSecretsForDeletion/index.js --target=node14
